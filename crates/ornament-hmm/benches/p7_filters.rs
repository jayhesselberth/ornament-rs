...
//!
//! Run:
//!   srun -p rna -c 24 cargo bench -p ornament-hmm --bench p7_filters
//!   cargo bench -p ornament-hmm --bench p7_filters -- forward

use std::hint::black_box;

use criterion::{criterion_group, criterion_main, Criterion, Throughput};
use ornament_alphabet::Alphabet;
use ornament_hmm::profile::bg_freqs;
use ornament_hmm::{
...
fn bench_filters(c: &mut Criterion) {
    ...
    {
        let sp = ornament_hmm::StripedProfile::new(&prof);
