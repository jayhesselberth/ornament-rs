//! `ornament-hmm`: native Rust port of the HMMER p7 machinery Infernal uses as its CM
//! acceleration filter (`P7_HMM` / `P7_PROFILE` + MSV/Viterbi/Forward).
//!
//! The CM core (`ornament-scfg`) is functionally complete without this — the p7 filter is an
